...
// vouched/openclaw. Written by hand like lib.d.ts. src/openclaw-types.test.ts
...
export declare function vouchedPlugin(
  options?: VouchedOpenClawOptions,
): VouchedOpenClawPlugin;

declare const plugin: VouchedOpenClawPlugin;
